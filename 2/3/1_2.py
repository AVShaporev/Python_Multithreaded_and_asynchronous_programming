'''
Сначала поток выполнит первую целевую задачу и получит результат. 
Затем запустит вторую задачу в качестве аргумента которой будет передан результат первой задачи:
'''
